...
export const FAQ_ENTRIES: FaqEntry[] = [
  ...
  },
  {
    ...
    steps: [
      'Clique no cabeçalho "Última visita" para inverter a ordem. A seta ao lado mostra o sentido atual.',
      ...
      "Quem nunca veio à clínica aparece no topo da ordem padrão e no fim da ordem invertida.",
    ...
    keywords: ["ordenar", "ordem", "página", "paginação", "reativação", "data", "última visita"],
  },
  {
    ...
    steps: [
      "Na lista de reativação, clique no ícone de lixeira na linha da pessoa e confirme.",
      "Isso serve para quem não é mais paciente de verdade: mudou de cidade, o telefone é de outra pessoa, ou veio junto numa importação de planilha antiga.",
      ...
      'Para apagar o cadastro de vez, use a exclusão na tela de Pacientes. A lixeira da reativação só aparece para quem tem a permissão "Editar pacientes".',
    ],
    keywords: ["tirar da lista", "remover", "reativação", "esconder", "não é mais paciente"],
  },
  {
