...
export const FAQ_ENTRIES: FaqEntry[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      "A ativação é feita na própria tela Plano, escolhendo mensal ou anual e a forma de pagamento.",
      "Se o pagamento pela tela ainda não estiver liberado, o botão avisa e o suporte pela Orbyniq resolve a ativação. O número fica no menu lateral.",
    ],
